...
import spotpy
import sys
sys.path.append("/data/torresh/python/pyrolysis-general")
...
sampler = spotpy.algorithms.sceua(spotpy_setup, dbname='SCEUA', dbformat='ram',alt_objfun="rmse_multiple_files", save_sim=False, parallel="mpi")
