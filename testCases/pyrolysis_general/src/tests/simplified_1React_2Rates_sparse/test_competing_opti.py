...
# filesCSV = ["SLOW_1.csv"]
# filesCSV = ["FAST_10000.csv"]
filesCSV = ["SLOW_1.csv","FAST_10000.csv"]

params = [
            spotpy.parameter.Uniform('E1',low=50E3 , high=100E3,  optguess=70E3),
            spotpy.parameter.Uniform('E2',low=90E3, high=200E3, optguess=10E4),
            spotpy.parameter.Uniform('A1', low=1, high=4, optguess=3.9),
            spotpy.parameter.Uniform('A2', low=6, high=15, optguess=3.9),
