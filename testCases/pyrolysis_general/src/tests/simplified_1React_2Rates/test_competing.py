...
test = PyrolysisCompetitive(temp_0=400, temp_end=1500, time=None, beta=1, n_points=600)
...
test.compute_time_temperature(temp_0=400, temp_end=1500, time=None, beta=10000, n_points=300)
test.solve_system()
# test.plot_solid_density()
#
rho = test.get_density()
